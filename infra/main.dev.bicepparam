...
// External ID for admin auth (keeping for backwards compatibility, but admin now uses main Azure AD tenant)
param externalTenantId = ''
param externalAdminClientId = ''
param externalAdminClientSecret = ''
// Auth0 for member CIAM authentication
param auth0Domain = 'dev-0tp5bbdn7af0lfpv.us.auth0.com'
param auth0ClientId = '08aK1L6WykfRrlhl0gsd4K24Ywy4xcpX'
